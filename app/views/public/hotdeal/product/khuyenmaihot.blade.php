...
@section('title_page'){{'Khuyến mãi hot'}}@endsection

@section('keyword_page'){{'Khuyến mãi hot'}}@endsection

@section('description_page'){{'Khuyến mãi hot'}}@endsection

@section('title-header'){{'Khuyến mãi hot'}}@endsection
