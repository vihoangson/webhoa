...
<div id="main-container" class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <!-- Breadcrumb Starts -->
            <ol class="breadcrumb">
                <li><a href="/assets/flower-shoppe/index.html">Home</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-col">
                        <div class="image">
                            <img src="/assets/flower-shoppe/images/product-images/15.png" alt="product" class="img-responsive" />
                        </div>
                        <div class="caption">
                            <h4><a href="/assets/flower-shoppe/product.html">Flowers</a></h4>
                            <div class="description">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-col">
                        <div class="image">
                            <img src="/assets/flower-shoppe/images/product-images/14.png" alt="product" class="img-responsive" />
                        </div>
                        <div class="caption">
                            <h4><a href="/assets/flower-shoppe/product.html">Flowers</a></h4>
                            <div class="description">
...
<footer id="footer-area">
    ...
    <div class="container">
        <div class="copyright clearfix">
            <!-- Starts -->
            <p class="pull-left">
                &copy; 2015 Flowers Shoppe All Rights Reserved. Designed By <a href="/assets/flower-shoppe/http://sainathchillapuram.com">Sainath Chillapuram</a>
            </p>
            <!-- Ends -->
