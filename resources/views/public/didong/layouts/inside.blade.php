    ...
    <div class="row">
        ...
        <div class="col-md-9 hidden">
            ...
            <div class="row">
                    ...
                    <div id="main-carousel" class="carousel slide slider" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/slider-imgs/slide1-img.jpg" alt="Slider" class="img-responsive img-center-xs" />
                            </div>
                            <div class="item">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/slider-imgs/slide2-img.jpg" alt="Slider" class="img-responsive img-center-xs" />
                            </div>
                        </div>
                ...
                <div class="col-sm-4 col-xs-12">
                    <ul class="list-unstyled top-banners">
                        <li><img src="{{config('templates.'.$template_name.'.template_path')}}images/banners/top-banner1.jpg" alt="banners" class="img-responsive img-center-xs" /></li>
                        <li><img src="{{config('templates.'.$template_name.'.template_path')}}images/banners/top-banner2.jpg" alt="banners" class="img-responsive img-center-xs" /></li>
                    </ul>
                </div>
                <!-- Banners Ends -->
            </div>
                ...
                <div class="row">
                    ...
                    <div class="item">
                        <div class="product-col">
                            <div class="image">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/product-images/6.jpg" alt="product" class="img-responsive" />
                            </div>
                            <div class="caption">
                                <h4><a href="{{config('templates.'.$template_name.'.template_path')}}product.html">Digital Electro Goods</a></h4>
                                <div class="price">
            ...
            <div class="col1-banners">
                <img src="{{config('templates.'.$template_name.'.template_path')}}images/banners/1col-banner1.jpg" alt="banners" class="img-responsive img-center-sm img-center-xs" />
            </div>
            ...
            <section class="products-list">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="product-col">
                            <div class="image">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/product-images/9.jpg" alt="product" class="img-responsive img-center-sm img-center-xs" />
                            </div>
                            <div class="caption">
                                <h4>
                                    <a href="{{config('templates.'.$template_name.'.template_path')}}product-full.html">Digital Electro Goods</a>
                                </h4>
                                <div class="price">
                                    <span class="price-new">$199.50</span>
                                    <span class="price-old">$249.50</span>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="product-col">
                            <div class="image">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/product-images/10.jpg" alt="product" class="img-responsive img-center-sm img-center-xs" />
                            </div>
                            <div class="caption">
                                <h4>
                                    <a href="{{config('templates.'.$template_name.'.template_path')}}product-full.html">Digital Electro Goods</a>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="product-col">
                            <div class="image">
                                <img src="{{config('templates.'.$template_name.'.template_path')}}images/product-images/11.jpg" alt="product" class="img-responsive img-center-sm img-center-xs" />
                            </div>
                            <div class="caption">
                                <h4>
                                    <a href="{{config('templates.'.$template_name.'.template_path')}}product-full.html">Digital Electro Goods</a>
