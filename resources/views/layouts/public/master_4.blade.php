            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-collapse collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a aria-expanded="false" role="button" href="{{$template_path}}layouts.html"> Back to main Layout page</a>
                        </li>
                        <li class="dropdown">
                            <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown"> Menu item <span class="caret"></span></a>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="{{$template_path}}">Menu item</a></li>
                                <li><a href="{{$template_path}}">Menu item</a></li>
                                <li><a href="{{$template_path}}">Menu item</a></li>
                                <li><a href="{{$template_path}}">Menu item</a></li>
                            </ul>
...
<!-- Flot -->
<script src="{{$template_path}}js/plugins/flot/jquery.flot.js"></script>
<script src="{{$template_path}}js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="{{$template_path}}js/plugins/flot/jquery.flot.resize.js"></script>

<!-- ChartJS-->
<script src="{{$template_path}}js/plugins/chartJs/Chart.min.js"></script>

<!-- Peity -->
<script src="{{$template_path}}js/plugins/peity/jquery.peity.min.js"></script>
<!-- Peity demo -->
<script src="{{$template_path}}js/demo/peity-demo.js"></script>
